...
if q == 4 and (first_bit.isdigit() and sec_bit.isdigit() and th_bit.isdigit() and fourth_bit.isdigit()) and (int(first_bit,10) > 0 and int(first_bit,10) <= 255) and (int(sec_bit,10) > 0 and int(sec_bit,10) <= 255) and (int(th_bit,10) > 0 and int(th_bit,10) <= 255) and (int(fourth_bit,10) > 0 and int(fourth_bit,10) <= 255):
    ip = True
